...
{
    public class CheckImageValidationNotRequired : ActionFilterAttribute // todo: why not required?
    {
        private readonly string _imageName;
        private readonly int _imageSize;
        public CheckImageValidationNotRequired(string imageName,int imageSize)
        {
